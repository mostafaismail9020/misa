...
/**
 * Provides necessary meta information about the casblogaddon hmc extension.
 *
 *
 * @version ExtGen v5.7.0.5
 */
public class CasblogaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CasblogaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.casblogaddon.hmc.locales";
