 ...
 */
package com.sap.ibso.eservices.sagiaservices.core.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.sap.ibso.eservices.sagiaservices.core.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "misawebservice.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "misawebservice.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "misawebservice.oauth2.tokenUrl";

	private static final String DESC = "misawebservice.v2.description";
	private static final String TITLE = "misawebservice.v2.title";
	private static final String VERSION = "misawebservice.v2.version";
	private static final String LICENSE = "misawebservice.v2.license";
	private static final String LICENSE_URL = "misawebservice.v2.license.url";
	...
	public RequestMappingHandlerMapping requestMappingHandlerMapping(
		...
		@Qualifier(value="mvcResourceUrlProvider") final ResourceUrlProvider resourceUrlProvider
	)
	{
