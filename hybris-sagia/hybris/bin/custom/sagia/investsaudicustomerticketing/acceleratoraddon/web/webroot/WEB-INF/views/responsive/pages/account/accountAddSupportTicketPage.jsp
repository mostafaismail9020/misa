                ...
                <div class="account-section-form">
                    ...
                    <form:form method="post" commandName="supportTicketForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="ticket-question1">Ticket Question 01</label>
                            <input type="text" id="ticket-question1" class="ticket-questions form-control">
                        </div>
                        <div class="form-group">
                            <label for="ticket-question2">Ticket Question 02</label>
                            <input type="text" id="ticket-question2" class="ticket-questions form-control">
                        </div>
                        <div class="form-group">
                            <label for="ticket-question3">Ticket Question 03</label>
                            <input type="text" id="ticket-question3" class="ticket-questions form-control">
                        </div>
                        <div class="form-group">
                            <label for="ticket-question4">Ticket Question 04</label>
                            <input type="text" id="ticket-question4" class="ticket-questions form-control">
                        </div>
                        <div class="form-group">
                            <label for="ticket-question5">Ticket Question 05</label>
                            <input type="text" id="ticket-question5" class="ticket-questions form-control">
                        </div>
                        <div class="form-group">
                            <label for="ticket-question6">Ticket Question 06</label>
                            <input type="text" id="ticket-question6" class="ticket-questions form-control">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-push-6 accountButtons">
                                        <ycommerce:testId code="supportTicket_create_button">
                                            <button class="btn btn-primary btn-block" type="button" id="addTicket">
