...
<c:if test="${!isWOAUGMember}">
  <div class="border-header header-account ${empty supportTickets ? '':'no-border'}">
    <spring:theme code="text.account.${requestType}"  />
    <div class="account-section-header-add">
      <a href="add-support-ticket" class="btn btn-sagia btn-sagia-green btn-block add-address ticket-button" id="add-support-ticket-btn">
...
<div class="customer-ticketing account-overview-table request-responsive-table">
      ...
      <tbody>
        <c:forEach items="${searchPageData.results}" var="supportTicket">
          ...
          <tr class="responsive-table-item">
            ...
            <td>
              <a href="${myAccountsupportTicketDetailsUrl}" class="responsive-table-link table-url-color">
