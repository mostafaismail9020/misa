...
import com.investsaudi.constants.InvestsaudisecureportalWebConstants.RequestMappings;
...
public class SecurePortalBeforeControllerHandler implements BeforeControllerHandler
{
	...
	protected String getRedirectUrl(final String mapping, final boolean secured, final String otherParameters)
	{
		 ...
		 * siteBaseUrlResolutionService.getWebsiteUrlForSite(cmsSiteService.
		 * getCurrentSite(), secured, mapping, otherParameters); }
		 * 
		 * return siteBaseUrlResolutionService.getWebsiteUrlForSite(cmsSiteService.
		 * getCurrentSite(), secured, mapping);
		 */
	}
