...
/**
 * Action called when a opportunity is approved, verified by a Cs Agent
 */
public class ApproveOpportunityAutomatedWorkflowTemplateJob extends AbstractAutomatedWorkflowTemplateJob
{

	private static final Logger LOG = Logger.getLogger(ApproveOpportunityAutomatedWorkflowTemplateJob.class);
	...
	public WorkflowDecisionModel perform(final WorkflowActionModel currentAction)
	{
		...
		ticketStatusService.updateFromSCReviewToMisaFinalReview(currentTicket);
