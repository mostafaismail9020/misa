 ...
 */
public class ApprovedByMarketingAutomatedWorkflowTemplateJob extends AbstractAutomatedWorkflowTemplateJob
{

	private static final Logger LOG = Logger.getLogger(ApprovedByMarketingAutomatedWorkflowTemplateJob.class);
	...
	public WorkflowDecisionModel perform(final WorkflowActionModel currentAction)
	{
		...
		ticketStatusService.updateFromMisaFinalReviewToReady(currentTicket);
