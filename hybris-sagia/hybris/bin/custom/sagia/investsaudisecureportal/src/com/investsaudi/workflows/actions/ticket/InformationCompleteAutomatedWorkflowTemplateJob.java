...
/**
 * Action called when a information is complete, verified by a Cs Agent
 */
public class InformationCompleteAutomatedWorkflowTemplateJob extends AbstractAutomatedWorkflowTemplateJob
{

	private static final Logger LOG = Logger.getLogger(InformationCompleteAutomatedWorkflowTemplateJob.class);
	...
	public WorkflowDecisionModel perform(final WorkflowActionModel currentAction)
	{
		...
		ticketStatusService.updateFromMisaInitialReviewToReviewed(currentTicket);
