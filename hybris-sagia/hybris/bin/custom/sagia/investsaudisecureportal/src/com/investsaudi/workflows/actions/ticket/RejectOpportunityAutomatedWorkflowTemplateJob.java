...
/**
 * Action called when a opportunity is rejected, verified by a Cs Agent
 */
public class RejectOpportunityAutomatedWorkflowTemplateJob extends AbstractAutomatedWorkflowTemplateJob
{

	private static final Logger LOG = Logger.getLogger(RejectOpportunityAutomatedWorkflowTemplateJob.class);
	...
	public WorkflowDecisionModel perform(final WorkflowActionModel currentAction)
	{
		...
		ticketStatusService.updateFromSCReviewToSCRejected(currentTicket);
