 ...
 */
public class ValidOpportunityAutomatedWorkflowTemplateJob extends AbstractAutomatedWorkflowTemplateJob
{

	private static final Logger LOG = Logger.getLogger(ValidOpportunityAutomatedWorkflowTemplateJob.class);
	...
	public WorkflowDecisionModel perform(final WorkflowActionModel currentAction)
	{
		...
		ticketStatusService.updateFromReviewedToSCReview(currentTicket);
