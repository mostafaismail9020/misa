...
public class DefaultB2BRegistrationFacadeUnitTest extends TransactionTest
{
	...
	public void setUp()
	{
		...
		userService = mock(SagiaUserService.class);
	...
	public void registerTestExpectedException() throws CustomerAlreadyExistsException , PhoneNumberUsedException
	{
	...
	@Test
	public void registerTest() throws CustomerAlreadyExistsException,PhoneNumberUsedException
	{
