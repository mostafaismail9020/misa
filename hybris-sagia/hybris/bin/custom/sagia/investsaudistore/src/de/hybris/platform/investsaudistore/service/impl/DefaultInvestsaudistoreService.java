...
public class DefaultInvestsaudistoreService implements InvestsaudistoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultInvestsaudistoreService.class);
	...
	{
		return DefaultInvestsaudistoreService.class.getResourceAsStream("/investsaudistore/sap-hybris-platform.png");
	}
