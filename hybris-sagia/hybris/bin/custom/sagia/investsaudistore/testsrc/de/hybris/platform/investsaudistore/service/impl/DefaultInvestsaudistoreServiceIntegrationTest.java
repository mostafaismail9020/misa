...
import de.hybris.platform.investsaudistore.service.impl.DefaultInvestsaudistoreService;
 ...
 */
@IntegrationTest
public class DefaultInvestsaudistoreServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "investsaudistorePlatformLogo";

		// when
		final String logoUrl = investsaudistoreService.getHybrisLogoUrl(logoCode);
