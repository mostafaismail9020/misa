 ...
 */
package com.investsaudi.filters;
...
/**
 * Filter that initializes the session for the investsaudistorefront. This is a spring configured filter that is
...
public class StorefrontFilter extends OncePerRequestFilter
{
			...
			final FilterChain filterChain) throws IOException, ServletException
	{
		...
		LOG.info("########## isAnonymousUser: "+userService.isAnonymousUser(userService.getCurrentUser()) + " ******** "+" &&&&& "+request.getRequestURI().contains("j_spring_security_check"));
		if (sagiaConfigurationFacade.isEnableInvestSaudi2FactorAuthService()) {
