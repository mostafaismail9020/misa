...
public class NafathAuthenticationProvider extends AcceleratorAuthenticationProvider {

	private static final Logger LOG = Logger.getLogger(NafathAuthenticationProvider.class);
