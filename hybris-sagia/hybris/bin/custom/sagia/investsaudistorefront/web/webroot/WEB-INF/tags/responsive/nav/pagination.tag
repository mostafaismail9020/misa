...
<c:if test="${searchPageData.pagination.totalNumberOfResults > 0}">
    <div class="pagination-main pagination-bar ${(top)?"top":"bottom"}">
            ...
            <c:if test="${not empty searchPageData.sorts}">
                ...
                <div class="sort-refine-bar">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="d-flex form-group">
                                ...
                                <form id="sortForm${top ? '1' : '2'}" name="sortForm${top ? '1' : '2'}" method="get"
                                      action="#">
                                        <img src="${commonResourcePath}/images/down-arrow.png" alt="" class="select-img" />
                                    ...
                                    <c:if test="${not empty oppType}">
                                    	<input type="hidden" id="oppType" name="oppType" value="${oppType}"/>
                                    </c:if>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 pagination-custom pagination-wrap">
