    ...
    <ul class="pagination">
        <c:if test="${hasPreviousPage}">
            <li class="pagination-prev">
                ...
                <ycommerce:testId code="searchResults_previousPage_link">
                    ...
                    <img src="${commonResourcePath}/images/arrow_left.png" width="30" height="31" alt="" /></a>
                </ycommerce:testId>
            </li>
        </c:if>
        ...
        <c:if test="${!hasPreviousPage}">
            <li class="pagination-prev disabled">
             <img src="${commonResourcePath}/images/arrow_left.png" width="30" height="31" alt="" /></li>
        </c:if>
            ...
            <li class="pagination-next">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" rel="next">
                     <img src="${commonResourcePath}/images/arrow_right.png" width="30" height="31" alt="" /></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasNextPage}">
            <li class="pagination-next disabled"><img src="${commonResourcePath}/images/arrow_right.png" width="30" height="31" alt="" /></li>
        </c:if>
    </ul>
</c:if>