    ...
    <div class="col-sm-12 col-no-padding">
        ...
        <c:if test="${not empty ticketData.opportunityMessage}">
            <div class="col-sm-3 item-wrapper">
                <div class="item-group">
	                <span class="item-label">
        				<spring:theme code="text.account.supporttickets.createTicket.opportunityMessage" text="Message"/>
        			</span>
                    <span class="item-value">
...
<c:if test="${ticketData.status.id eq 'WOAGPENDINGAPPROVAL'}">
    <form:form method="get" modelAttribute="supportTicketForm" enctype="multipart/form-data" id="opportunitySupportTicketForm" action="#">
        ...
        <div class="modal-actions row" style="margin-top: 10px; margin-bottom: 10px; display: flex">
            <div class="col-xs-8 col-sm-8">
                <formElement:formTextArea idKey="message" labelKey="text.account.supporttickets.createTicket.message"
                                          path="message" areaCSS="form-control js-add-message opportunity-status-message"
    ...
    <div class="col-xs-12">
        ...
        <div class="cts-msg-history">
            ...
            <div style="display: none">
                ...
                <span id="opportunity-approve-message"><spring:theme code="text.account.opportunity.approve.confirmation.message" arguments="${ticketData.id}"/></span>
                <span id="opportunity-reject-message"><spring:theme code="text.account.opportunity.reject.confirmation.message" arguments="${ticketData.id}"/></span>
            </div>
