					...
					<div class="first">
						...
						<div class="search-area">
							<form action="<c:url value="/search"/>" id="form-search"  onsubmit="if(!document.getElementById('invest-search').value) return false">
								<input type="text" name="text" id="invest-search">
                <i class="glyphicon glyphicon-search" onclick="if(document.getElementById('invest-search').value) document.getElementById('form-search').submit();"></i>
							</form>
						</div>
					</div>
					<div class="second row">
						<div class="col-md-4 col-xl-4 nav__left new-logo">
							<cms:pageSlot position="SiteLogo" var="logo" limit="1">
								<cms:component component="${logo}" element="div" class="yComponentWrapper"/>
							</cms:pageSlot>
              <img src="${commonResourcePath}/images/logo-en.svg" >
						</div>
