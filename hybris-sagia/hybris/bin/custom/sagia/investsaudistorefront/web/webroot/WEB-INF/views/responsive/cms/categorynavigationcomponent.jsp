		...
		<div class="navigation__overflow">
			...
			<div class="search-area">
				<form action="<c:url value="/search"/>" id="form-search"  onsubmit="if(!document.getElementById('invest-search').value) return false">
					<input type="text" name="text" id="invest-search" ><i class="glyphicon glyphicon-search"
													  onclick="if(document.getElementById('invest-search').value) document.getElementById('form-search').submit();"></i>
				</form>
			</div>
		</div>
	</nav>
