                                      ...
                                      <c:forEach items="${childLevel2.links}" var="childlevel3link">
                                        <c:choose>
                                          <c:when test="${not empty childlevel3link.url}">
                                            <li><a class="get_submenus" href="${childlevel3link.url}">${childlevel3link.linkName}</a></li>
                                          </c:when>
                                          <c:otherwise>
                                            <li><a class="get_submenus" href="${portal.cmsLinkUrl(childlevel3link)}">${childlevel3link.linkName}</a></li>
                                          </c:otherwise>
                                        </c:choose>
                                      </c:forEach>
                                    </ul>
                                ...
                                <c:if test="${not empty childLevel2.links}">
                                  <ul class="submenu dropdown-menu get_submenus">
                                    <c:forEach items="${childLevel2.links}" var="childlevel3link">
                                      <c:choose>
                                        <c:when test="${not empty childlevel3link.url}">
                                          <li><a class="get_submenus" href="/${language}${childlevel3link.url}">${childlevel3link.linkName}</a></li>
                                        </c:when>
                                        <c:otherwise>
                                          <li><a class="get_submenus" href="${portal.cmsLinkUrl(childlevel3link)}">${childlevel3link.linkName}</a></li>
                                        </c:otherwise>
