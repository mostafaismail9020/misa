...
<div class="headline" style="margin-left: 3rem;font-weight: 700;">Create New User Page</div>
  	...
  	<div class="row">
  	  ...
  	  <div class="col-md-6">
           <div class="form-group">
                <label class="control-label control-label_mandatory label-color" for="text.account.newUser"> <spring:theme code="text.account.newUser" text="Title"/></label>
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
            <div class="form-group">
                 <label class="control-label control-label_mandatory label-color" for="text.account.newUser"> <spring:theme code="text.account.newUser" text="Parent Unit"/></label>
            ...
            <div class="col-md-12">
               <div class="form-group">
                    <label class="control-label control-label_mandatory label-color" for="text.account.newUser"> <spring:theme code="text.account.newUser" text="Role"/></label>
                     <br/><c:forEach var="userGroup" items="${userGroups}">
                     <c:choose>
                      <c:when test="${userGroup eq 'b2bCustomerGroup'}">
                           <input type="radio" name="role" value="${userGroup}" checked>
                                      <span><spring:message code="text.account.role.${userGroup}"/></span>&nbsp;&nbsp;&nbsp;
                      </c:when>
                        <c:otherwise>
    ...
    <div class="col-md-6"></div>
     <div class="col-md-6">
             <div class="form-group" style = "float:right;">
                 <button  style = "width:200px; background-color:gray;" class="btn btn-sagia btn-sagia-green " type="button" id="addNewUserCancel">
                      Cancel
                  </button>
                 <button style = "width:200px;" class="btn btn-sagia btn-sagia-green" type="button" id="addNewUserSubmit">
