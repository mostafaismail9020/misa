 ...
 */
package de.hybris.platform.sagiaasmaddon.controllers;
...
public class AdditionalInformationController
{
	...
	private static final String CUSTOMER_360_PAGE = "addon:/sagiaasmaddon/pages/customer360";
	private static final String CUSTOMER_360_FRAGMENT_404_PAGE = "addon:/sagiaasmaddon/fragments/customer360/fragment404";
	private static final String CUSTOMER_360_SECTION = "addon:/sagiaasmaddon/pages/section";
...
//	@RequestMapping(value = "/customer360section", method = RequestMethod.GET)
	public String getCustomer360Section(final Model model, @RequestParam("sectionId") final String sectionId)
	{
		...
		model.addAttribute(AIF_AJAX_TIMEOUT, Integer.valueOf(Config.getInt(SagiaasmaddonConstants.AIF_TIMEOUT,
				SagiaasmaddonConstants.AIF_DEFAULT_TIMEOUT)));
