 ...
 */
package de.hybris.platform.sagiaasmaddon.controllers.cms;
...
import de.hybris.platform.sagiaasmaddon.security.AssistedServiceAgentAuthoritiesManager;
import de.hybris.platform.sagiaasmaddon.security.impl.AssistedServiceAgentLoginStrategy;
import de.hybris.platform.sagiaasmaddon.security.impl.AssistedServiceAgentLogoutStrategy;
import de.hybris.platform.sagiaasmaddon.security.impl.AssistedServiceAuthenticationToken;
import de.hybris.platform.sagiaasmaddon.util.SubscriptionFacadeReflectionWrapper;
...
{
	private static final String ASSISTED_SERVICE_COMPONENT = "addon:/sagiaasmaddon/cms/asm/assistedServiceComponent";
	...
	protected boolean isASAgent(final UserModel currentUser)
	{
		...
		{
			if (SagiaasmaddonConstants.AS_AGENT_GROUP_UID.equals(userGroup.getUid()))
			{
				return true;
			}
		}
