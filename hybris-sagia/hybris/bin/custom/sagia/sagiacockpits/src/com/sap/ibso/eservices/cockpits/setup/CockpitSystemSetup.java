 ...
 */
package com.sap.ibso.eservices.cockpits.setup;
...
import com.sap.ibso.eservices.cockpits.constants.SagiaCockpitsConstants;
 ...
 */
@SystemSetup(extension = SagiaCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SagiaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SagiaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SagiaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/sagiacockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
