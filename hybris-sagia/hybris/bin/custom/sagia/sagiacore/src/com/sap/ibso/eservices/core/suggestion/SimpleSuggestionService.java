 ...
 */
package com.sap.ibso.eservices.core.suggestion;
...
public interface SimpleSuggestionService
{
	 ...
	 * Returns a list of referenced products for a product purchased in a category identified by categoryCode.
	 *
	 * @param category - The category for which the products are retrieved.
	 * @param user - The user for which the products are retrieved.
	 ...
	 *
	 * @param products - The products for which the referenced producs are retrieved.
	 * @param user - The user.
	 * @param referenceTypes
	 *           optional referenceTypes
	 * @param excludePurchased
