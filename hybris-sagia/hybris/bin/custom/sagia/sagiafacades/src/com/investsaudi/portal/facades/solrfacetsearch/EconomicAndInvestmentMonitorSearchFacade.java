 ...
 */
public interface EconomicAndInvestmentMonitorSearchFacade<ITEM extends InvestSaudiResourceComponentData>
{
	/**
	 ...
	 */
	EconomicAndInvestmentMonitorSearchPageData<SearchStateData, ITEM> textSearch(String text);
	 ...
	 * @return the search results
	 */
	EconomicAndInvestmentMonitorSearchPageData<SearchStateData, ITEM> textSearch(String text, SearchQueryContext searchQueryContext);
	 ...
	 * @return the search results
	 */
	EconomicAndInvestmentMonitorSearchPageData<SearchStateData, ITEM> textSearch(SearchStateData searchState, PageableData pageableData);
