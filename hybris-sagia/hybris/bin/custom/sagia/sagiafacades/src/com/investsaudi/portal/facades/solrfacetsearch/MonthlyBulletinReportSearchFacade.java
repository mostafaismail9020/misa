 ...
 */
public interface MonthlyBulletinReportSearchFacade<ITEM extends InvestSaudiResourceComponentData>
{
	/**
	 ...
	 */
	MonthlyBulletinReportSearchPageData<SearchStateData, ITEM> textSearch(String text);
	 ...
	 * @return the search results
	 */
	MonthlyBulletinReportSearchPageData<SearchStateData, ITEM> textSearch(String text, SearchQueryContext searchQueryContext);
	 ...
	 * @return the search results
	 */
	MonthlyBulletinReportSearchPageData<SearchStateData, ITEM> textSearch(SearchStateData searchState, PageableData pageableData);
