...
public class EconomicAndInvestmentMonitortSearchAutocompleteService extends DefaultSolrProductSearchAutocompleteService {
    ...
    public List<AutocompleteSuggestion> getAutocompleteSuggestions(final String input)
    {
        ...
        try
        {
            ...
            solrFacetSearchConfigDao.findFacetSearchConfigByName("sagiaEconomicAndInvestmentMonitorIndex");

            final FacetSearchConfig facetSearchConfig = getFacetSearchConfigService()
                    .getConfiguration("sagiaEconomicAndInvestmentMonitorIndex");
