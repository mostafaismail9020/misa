...
public class InvestmentHighlightsReportSearchAutocompleteService extends DefaultSolrProductSearchAutocompleteService {
    ...
    public List<AutocompleteSuggestion> getAutocompleteSuggestions(final String input)
    {
        ...
        try
        {
            ...
            solrFacetSearchConfigDao.findFacetSearchConfigByName("sagiaInvestmentHighlightsReportIndex");

            final FacetSearchConfig facetSearchConfig = getFacetSearchConfigService()
                    .getConfiguration("sagiaInvestmentHighlightsReportIndex");
