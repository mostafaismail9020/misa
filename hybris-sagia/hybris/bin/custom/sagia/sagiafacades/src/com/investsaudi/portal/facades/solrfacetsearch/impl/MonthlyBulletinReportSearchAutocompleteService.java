...
public class MonthlyBulletinReportSearchAutocompleteService extends DefaultSolrProductSearchAutocompleteService {
    ...
    public List<AutocompleteSuggestion> getAutocompleteSuggestions(final String input)
    {
        ...
        try
        {
            ...
            solrFacetSearchConfigDao.findFacetSearchConfigByName("sagiaMonthlyBulletinReportIndex");

            final FacetSearchConfig facetSearchConfig = getFacetSearchConfigService()
                    .getConfiguration("sagiaMonthlyBulletinReportIndex");
