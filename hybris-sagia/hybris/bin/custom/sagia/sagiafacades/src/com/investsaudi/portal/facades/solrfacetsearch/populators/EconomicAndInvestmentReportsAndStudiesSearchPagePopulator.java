...
/**
 */
public class EconomicAndInvestmentReportsAndStudiesSearchPagePopulator<QUERY, STATE, RESULT, ITEM extends EconomicAndInvestmentReportsAndStudiesData, SCAT, CATEGORY>
		implements Populator<EconomicAndInvestmentReportsAndStudiesSearchPageData<QUERY, RESULT>, EconomicAndInvestmentReportsAndStudiesSearchPageData<STATE, ITEM>>
{
	...
	private Converter<RESULT, ITEM> searchResultEconomicAndInvestmentReportsAndStudiesConverter;
	...
	protected Converter<RESULT, ITEM> getSearchResultEconomicAndInvestmentReportsAndStudiesConverter()
	{
		return searchResultEconomicAndInvestmentReportsAndStudiesConverter;
	}

	@Required
	public void setSearchResultEconomicAndInvestmentReportsAndStudiesConverter(final Converter<RESULT, ITEM> searchResultEconomicAndInvestmentReportsAndStudiesConverter)
	{
		this.searchResultEconomicAndInvestmentReportsAndStudiesConverter = searchResultEconomicAndInvestmentReportsAndStudiesConverter;
	}
	...
	@Override
	public void populate(final EconomicAndInvestmentReportsAndStudiesSearchPageData<QUERY, RESULT> source,
			final EconomicAndInvestmentReportsAndStudiesSearchPageData<STATE, ITEM> target)
	{
		...
		{
			target.setResults(Converters.convertAll(source.getResults(), getSearchResultEconomicAndInvestmentReportsAndStudiesConverter()));
		}
