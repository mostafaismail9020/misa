...
/**
 */
public class MonthlyBulletinReportSearchPagePopulator<QUERY, STATE, RESULT, ITEM extends MonthlyBulletinReportData, SCAT, CATEGORY>
		implements Populator<MonthlyBulletinReportSearchPageData<QUERY, RESULT>, MonthlyBulletinReportSearchPageData<STATE, ITEM>>
{
	...
	private Converter<RESULT, ITEM> searchResultMonthlyBulletinReportConverter;
	...
	protected Converter<RESULT, ITEM> getSearchResultMonthlyBulletinReportConverter()
	{
		return searchResultMonthlyBulletinReportConverter;
	}

	@Required
	public void setSearchResultMonthlyBulletinReportConverter(final Converter<RESULT, ITEM> searchResultMonthlyBulletinReportConverter)
	{
		this.searchResultMonthlyBulletinReportConverter = searchResultMonthlyBulletinReportConverter;
	}
	...
	@Override
	public void populate(final MonthlyBulletinReportSearchPageData<QUERY, RESULT> source,
			final MonthlyBulletinReportSearchPageData<STATE, ITEM> target)
	{
		...
		{
			target.setResults(Converters.convertAll(source.getResults(), getSearchResultMonthlyBulletinReportConverter()));
		}
