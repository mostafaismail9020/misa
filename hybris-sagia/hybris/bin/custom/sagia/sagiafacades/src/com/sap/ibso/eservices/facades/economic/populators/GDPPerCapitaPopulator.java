  ...
  com.sap.ibso.eservices.facades.data.GDPPerCapitaData;
  
  public class GDPPerCapitaPopulator implements Populator<GDPPerCapitaModel,
  GDPPerCapitaData> {
  
  @Override public void populate(final GDPPerCapitaModel source, final
  GDPPerCapitaData target) throws ConversionException {
