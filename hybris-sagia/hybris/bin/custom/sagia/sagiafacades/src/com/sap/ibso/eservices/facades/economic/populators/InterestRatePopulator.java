  ...
  com.sap.ibso.eservices.facades.data.InterestRateData;
  
  public class InterestRatePopulator implements Populator<InterestRateModel,
  InterestRateData> {
  
  @Override public void populate(final InterestRateModel source, final
  InterestRateData target) throws ConversionException {
