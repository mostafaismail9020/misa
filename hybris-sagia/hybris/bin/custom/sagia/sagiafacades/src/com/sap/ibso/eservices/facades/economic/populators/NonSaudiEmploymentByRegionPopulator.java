...
public class NonSaudiEmploymentByRegionPopulator
		implements Populator<NonSaudiEmploymentByRegionModel, NonSaudiEmploymentByRegionData> {

	@Override
	public void populate(NonSaudiEmploymentByRegionModel source, NonSaudiEmploymentByRegionData target)
		...
		target.setTotalPopulation(source.getTotalEmployment());
