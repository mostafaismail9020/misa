...
public class QuarterlyValuePopulator
		implements Populator<QuarterlyValueModel, QuarterlyValueData> {

	@Override
	public void populate(QuarterlyValueModel source, QuarterlyValueData target) throws ConversionException {
