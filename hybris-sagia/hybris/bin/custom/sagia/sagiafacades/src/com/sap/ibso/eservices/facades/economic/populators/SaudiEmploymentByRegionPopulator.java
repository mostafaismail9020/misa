...
public class SaudiEmploymentByRegionPopulator
		implements Populator<SaudiEmploymentByRegionModel, SaudiEmploymentByRegionData> {

	@Override
	public void populate(SaudiEmploymentByRegionModel source, SaudiEmploymentByRegionData target)
