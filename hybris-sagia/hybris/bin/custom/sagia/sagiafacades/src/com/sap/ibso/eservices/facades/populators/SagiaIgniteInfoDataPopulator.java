...
import com.sap.ibso.eservices.sagiaservices.data.SagiaIgniteServiceInfo;
...
public class SagiaIgniteInfoDataPopulator implements Populator<SagiaIgniteServiceInfoDataCRM, SagiaIgniteServiceInfo> {
     ...
     */
    @Override
    public void populate(SagiaIgniteServiceInfoDataCRM source, SagiaIgniteServiceInfo target) {
