...
import com.sap.ibso.eservices.sagiaservices.data.SagiaCRMIgniteServiceData;
...
public class SagiaIgniteServiceCRMPopulator implements Populator<SagiaCRMIgniteService, SagiaCRMIgniteServiceData> {
     ...
     */
    @Override
    public void populate(SagiaCRMIgniteService source, SagiaCRMIgniteServiceData target) throws ConversionException {
