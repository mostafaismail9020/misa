...
public class AttachmantHDRReversePopulator implements Populator<AttachmantHDR, AttachmantHDRData> {
    /**
     * Populate from AttachmantHDR to AttachmantHDRData
     * @param source the source object
     * @param target the target to fill
     * @throws ConversionException
     */
    @Override
    public void populate(AttachmantHDR source, AttachmantHDRData target) throws ConversionException {
