...
public class LegalInquiryReversePopulator implements Populator<LegalInquiry, LegalInquiryData> {
    /**
     * Populate from LegalInquiry to LegalInquiryData
     * @param source the source object
     * @param target the target to fill
     * @throws ConversionException
     */
    @Override
    public void populate(LegalInquiry source, LegalInquiryData target) throws ConversionException {
