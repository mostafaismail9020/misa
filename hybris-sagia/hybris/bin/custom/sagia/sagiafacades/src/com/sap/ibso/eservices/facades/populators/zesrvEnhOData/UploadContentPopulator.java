...
public class UploadContentPopulator implements Populator<UploadContentData, UploadContent> {
    /**
     * Populate from UploadContentData to UploadContent
    ...
    @Override
    public void populate(UploadContentData source, UploadContent target) throws ConversionException {
