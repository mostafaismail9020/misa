...
public class DefaultSagiainvestsaudistoreService implements SagiainvestsaudistoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSagiainvestsaudistoreService.class);
	...
	{
		return DefaultSagiainvestsaudistoreService.class.getResourceAsStream("/sagiainvestsaudistore/sap-hybris-platform.png");
	}
