...
public class SagiaIgniteServiceDataPopulator extends ODataPopulator<SagiaCRMIgniteService> {
	
	private GetTextDataPopulator getTextDataPopulator;
	private ContentHDRPopulator contentHDRPopulator;

	@Override
	public void populate(ODataModel model, SagiaCRMIgniteService sagiaService) throws ConversionException {
