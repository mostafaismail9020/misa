...
public class EntityInformationODataPopulator extends ODataPopulator<EntityInformationData> {
    @Override
    public void populate(ODataModel model, EntityInformationData basicContactInformationData) throws ConversionException {
