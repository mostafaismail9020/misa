...
/**
 * Defines license amendment parameters for a price simulation. The parameters specify the scenario of an amendment type in focus.
 * Supported amendment types are shareholder amendment, branch amendment, product amendment and entity amendment.
 */
public class AmendmentParam implements Serializable
{
