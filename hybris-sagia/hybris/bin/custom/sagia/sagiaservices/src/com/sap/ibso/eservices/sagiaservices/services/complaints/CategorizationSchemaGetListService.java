...
/**
 * CategorizationSchemaGetListService
 */
public class CategorizationSchemaGetListService extends AbstractSagiaService<CategorizationSchemaGetListData> {
	/**
