 ...
 * @copyright 2018 SAP
 */
public class SagiaGovtService extends AbstractSagiaService<SagiaCRMGovtService> {
    private static final String FILTER_BY_SERVICE_TYPE = "ServiceType eq '";
    private SagiaGovtServiceDAO sagiaGovtServiceDAO;

    private static final Logger LOGGER = LoggerFactory.getLogger(SagiaGovtService.class);
    /**
     ...
     */
    public Collection<SagiaCRMGovtService> getCRMServicesByCategory(String serviceUrl) {
        try {
            return super.getCollection(SagiaCRMGovtService.class, REQUEST_PARAMETER_FILTER, FILTER_BY_SERVICE_TYPE + serviceUrl + "'");
        } catch(Exception e) {
     ...
     */
    public SagiaCRMGovtService getCRMServiceById(String serviceId) {
        return super.get(SagiaCRMGovtService.class, (Object)serviceId, REQUEST_PARAMETER_EXPAND, "GovtServicesToContentHDRNav,GovtServicesToTextNav");
    }
