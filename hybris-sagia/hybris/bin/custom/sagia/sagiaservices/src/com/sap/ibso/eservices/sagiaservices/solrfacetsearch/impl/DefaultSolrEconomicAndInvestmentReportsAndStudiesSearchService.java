 ...
 */
public class DefaultSolrEconomicAndInvestmentReportsAndStudiesSearchService<ITEM> implements
		EconomicAndInvestmentReportsAndStudiesSearchService<SolrSearchQueryData, ITEM, EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM>>
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(DefaultSolrEconomicAndInvestmentReportsAndStudiesSearchService.class);
	...
	private Converter<SolrSearchResponse, EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM>> searchResponseConverter;
	...
	protected Converter<SolrSearchResponse, EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM>> getSearchResponseConverter()
	{
	...
	public void setSearchResponseConverter(
			final Converter<SolrSearchResponse, EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM>> searchResponseConverter)
	{
	...
	@Override
	public EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM> textSearch(final String text,
	...
	@Override
	public EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM> searchAgain(
			final SolrSearchQueryData searchQueryData, final PageableData pageableData)
	{
		return doSearch(searchQueryData, pageableData);
	}

	protected EconomicAndInvestmentReportsAndStudiesSearchPageData<SolrSearchQueryData, ITEM> doSearch(
			final SolrSearchQueryData searchQueryData, final PageableData pageableData)
	{
