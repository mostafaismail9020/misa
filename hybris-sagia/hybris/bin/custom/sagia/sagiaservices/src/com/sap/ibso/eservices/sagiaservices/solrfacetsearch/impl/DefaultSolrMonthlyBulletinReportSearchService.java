 ...
 */
public class DefaultSolrMonthlyBulletinReportSearchService<ITEM> implements
		MonthlyBulletinReportSearchService<SolrSearchQueryData, ITEM, MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM>>
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(DefaultSolrMonthlyBulletinReportSearchService.class);
	...
	private Converter<SolrSearchResponse, MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM>> searchResponseConverter;
	...
	protected Converter<SolrSearchResponse, MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM>> getSearchResponseConverter()
	{
	...
	public void setSearchResponseConverter(
			final Converter<SolrSearchResponse, MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM>> searchResponseConverter)
	{
	...
	@Override
	public MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM> textSearch(final String text,
	...
	@Override
	public MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM> searchAgain(
			final SolrSearchQueryData searchQueryData, final PageableData pageableData)
	{
		return doSearch(searchQueryData, pageableData);
	}

	protected MonthlyBulletinReportSearchPageData<SolrSearchQueryData, ITEM> doSearch(
			final SolrSearchQueryData searchQueryData, final PageableData pageableData)
	{
