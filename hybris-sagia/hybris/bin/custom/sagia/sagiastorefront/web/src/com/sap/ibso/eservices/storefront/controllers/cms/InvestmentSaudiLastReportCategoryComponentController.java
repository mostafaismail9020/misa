...
public class InvestmentSaudiLastReportCategoryComponentController extends AbstractAcceleratorCMSComponentController<InvestmentSaudiLastReportCategoryComponentModel> {
    ...
    protected void fillModel(HttpServletRequest request, Model model, InvestmentSaudiLastReportCategoryComponentModel component) {
        model.addAttribute("lastReportsBox1", new ReportDto(new Date(), component.getBox1Name(), "/economic/investmentReports/categoryName1", "/medias/news-national-center-for-waste-management-thumbnail.jpg?context=bWFzdGVyfHBvcnRhbC1tZWRpYXwyNDczOHxpbWFnZS9qcGVnfHBvcnRhbC1tZWRpYS9oNzIvaGIzLzg4Njk1MzQzMzUwMDYuanBnfDg5OWUwOGY5ZmRmNzA5NjY4ZDY5NmNiMGNmNGI0NjYzM2RhNTQ2YmI2YWMyODhkNmNhM2JmNzhiMjUxZGI5M2U")); //Economic and Investment Monitor
        model.addAttribute("lastReportsBox2", new ReportDto(new Date(), component.getBox2Name(), "/economic/investmentReports/categoryName1", "/medias/news-ministers-of-Misa-and-Malaysia-thumbnail.jpg?context=bWFzdGVyfHBvcnRhbC1tZWRpYXwyMTM3M3xpbWFnZS9qcGVnfHBvcnRhbC1tZWRpYS9oYjIvaDg2Lzg4Njk1MzQ1NjQzODIuanBnfGQwZWY2ZGY0YWExMWVkMzQ3NzU4ZTU2NWVhYzhkYWUwNGRmNTNhMzEwZDE3YzExODgxOGNkOTYzM2NkMGI0NDU")); //Investment Highlights
        ...
        model.addAttribute("lastReportsBox4", new ReportDto(new Date(), component.getBox4Name(), "/economic/investmentReports/categoryName1", "/medias/news-saudi-uzbek-thumbnail.jpg?context=bWFzdGVyfHBvcnRhbC1tZWRpYXwyMDM3N3xpbWFnZS9qcGVnfHBvcnRhbC1tZWRpYS9oNjAvaDU3Lzg4Njk1MzQzMDIyMzguanBnfGI4NDVlMjFmYWIxMDZjNDlhY2ZmOTRkZmY3ZjMyZDY4Yjc0MmE1NTYxNjVjMzU2NGYwYTE0MWYzMTFkYzZhNWE")); //Economic and Investment Reports & Studies
    }
