 ...
 */
@Controller("MeetTheKingdomKeyReasonsContainerController")
@RequestMapping("/view/MeetTheKingdomKeyReasonsContainerController")
public class MeetTheKingdomKeyReasonsContainerController extends AbstractAcceleratorCMSComponentController<MeetTheKingdomKeyReasonsContainerModel>
{
	private static final Logger LOG = LoggerFactory.getLogger(MeetTheKingdomKeyReasonsContainerController.class);
	
	@Override
	protected void fillModel(final HttpServletRequest request, final Model model, final MeetTheKingdomKeyReasonsContainerModel component)
	{
