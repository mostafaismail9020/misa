 ...
 */
@Controller("MeetTheKingdomMacroEconomicContainerController")
@RequestMapping("/view/MeetTheKingdomMacroEconomicContainerController")
public class MeetTheKingdomMacroEconomicContainerController extends AbstractAcceleratorCMSComponentController<MeetTheKingdomMacroEconomicContainerModel>
{
	private static final Logger LOG = LoggerFactory.getLogger(MeetTheKingdomMacroEconomicContainerController.class);
	
	@Override
	protected void fillModel(final HttpServletRequest request, final Model model, final MeetTheKingdomMacroEconomicContainerModel component)
	{
