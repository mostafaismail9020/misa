...
public class StoreSessionController extends AbstractController {
    ...
    private UiExperienceLevel toUiExperienceLevel(final String code) {
    ...
    private List<UiExperienceLevel> getAvailableUiExperienceLevels() {
        return enumerationService.getEnumerationValues(UiExperienceLevel.class);
    }

    private String[] getAvailableUiExperienceLevelsCodes() {
    ...
    private void setHideUiExperienceLevelOverridePrompt(final HttpServletRequest request, final boolean flag) {
        request.getSession().setAttribute("hideUiExperienceLevelOverridePrompt", flag);
    }

    private String getReturnRedirectUrl(final HttpServletRequest request) {
    ...
    private String getReturnRedirectUrlWithoutReferer(final HttpServletRequest request) {
    ...
    private String getReturnRedirectUrlForUrlEncoding(final HttpServletRequest request, final String old, final String current) {
        final String originalReferer = (String) request.getSession().getAttribute(ORIGINAL_REFERER);
        if (StringUtils.isNotBlank(originalReferer)) {
