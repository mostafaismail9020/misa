...
public class InvestmentHighlightsReportSearchPageController extends AbstractSearchPageController
{
	...
	private static final String SEARCH_CMS_PAGE_ID = "reports-investment-highlights-search";
	private static final int NUM_OF_RECORD_PER_PAGE = 9;

	@Resource(name = "investmentHighlightsReportSearchFacade")
	private InvestmentHighlightsReportSearchFacade<InvestmentHighlightsReportData> investmentHighlightsReportSearchFacade;
			...
			final HttpServletRequest request, final Model model) throws CMSItemNotFoundException
	{
		...
		InvestmentHighlightsReportSearchPageData<SearchStateData,
				InvestmentHighlightsReportData> searchPageData = null;

		InvestmentHighlightsReportSearchPageData<SearchStateData,
				InvestmentHighlightsReportData> solrSearchPageData = null;
		...
		else
		{
			...
			List<InvestmentHighlightsReportData> investmentHighlightsReportDataList = new ArrayList<>();
			for (InvestmentHighlightsReportData investmentHighlightsReportData : searchPageData.getResults()) {
				investmentHighlightsReportDataList.add(investmentHighlightsReportData);
			}
			SearchPageData<InvestmentHighlightsReportData> investmentHighlightsReportDataSearchPageData = new SearchPageData<>();
			investmentHighlightsReportDataSearchPageData.setResults(investmentHighlightsReportDataList);
			...
			investmentHighlightsReportDataSearchPageData.setPagination(sagiaPaginationData);
			model.addAttribute("solrSearchPageData", solrSearchPageData);
			model.addAttribute("searchPageData", investmentHighlightsReportDataSearchPageData);
		}
	...
	protected
	InvestmentHighlightsReportSearchPageData<SearchStateData,
			InvestmentHighlightsReportData> encodeSearchCustomePageData(
			final
			InvestmentHighlightsReportSearchPageData<SearchStateData,
					InvestmentHighlightsReportData> searchPageData)
	{
	...
	protected InvestmentHighlightsReportSearchPageData<SearchStateData, InvestmentHighlightsReportData> performSearch(final String searchQuery, final int page,
			final ShowMode showMode, final String sortCode, final int pageSize)
	{
		...
		searchState.setQuery(searchQueryData);
		InvestmentHighlightsReportSearchPageData<SearchStateData, InvestmentHighlightsReportData> searchText = investmentHighlightsReportSearchFacade.textSearch(searchState, pageableData);
	...
	public SearchResultsData<InvestmentHighlightsReportData> jsonSearchResults(@RequestParam("q") final String searchQuery,
			@RequestParam(value = "page", defaultValue = "0") final int page,
			@RequestParam(value = "show", defaultValue = "Page") final ShowMode showMode,
			@RequestParam(value = "sort", required = false) final String sortCode) throws CMSItemNotFoundException
	{
		...
		final SearchResultsData<InvestmentHighlightsReportData> searchResultsData = new SearchResultsData<>();
			...
			@RequestParam(value = "sort", required = false) final String sortCode) throws CMSItemNotFoundException
	{
		...
		final InvestmentHighlightsReportSearchPageData<SearchStateData, InvestmentHighlightsReportData> searchPageData = investmentHighlightsReportSearchFacade.textSearch(searchState,
