...
import com.sap.ibso.eservices.storefront.breadcrumb.OpportunityBreadcrumbBuilder;
...
public class ProductPageController extends AbstractPageController
{
	...
	private OpportunityBreadcrumbBuilder opportunityBreadcrumbBuilder;
			...
			final List<ProductOption> extraOptions) throws CMSItemNotFoundException
	{
		...
		storeCmsPageInModel(model, getPageForProduct(productCode));
		populateProductData(productData, model);
		model.addAttribute(WebConstants.BREADCRUMBS_KEY, opportunityBreadcrumbBuilder.getBreadcrumbs(productCode));
