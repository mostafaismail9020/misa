 ...
 */
package com.sap.ibso.eservices.storefront.filters.cms;
...
public class CMSSiteFilter extends OncePerRequestFilter implements CMSFilter {
    ...
    protected void doFilterInternal(final HttpServletRequest httpRequest, final HttpServletResponse httpResponse,
        ...
        final CmsPageRequestContextData cmsPageRequestContextData = getCmsPageContextService().initialiseCmsPageContextForRequest(httpRequest);
     ...
     *
     * @param httpRequest      current request
     * @param previewDataModel the preview data model
     ...
     *
     * @param httpRequest      current request
     * @param previewDataModel valid data model contains all necessary information
     * @return target URL
     */
