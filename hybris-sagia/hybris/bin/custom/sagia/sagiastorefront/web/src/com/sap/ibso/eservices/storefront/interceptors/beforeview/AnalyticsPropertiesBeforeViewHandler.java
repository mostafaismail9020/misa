...
public class AnalyticsPropertiesBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		if (jirafeMapCache.get(currSpecKey) != null
				&& org.apache.commons.lang.StringUtils.isNotBlank(jirafeMapCache.get(currSpecKey)))
		{
	...
	protected class ConfigChangeListenerImpl implements ConfigIntf.ConfigChangeListener
	{
		@Override
	...
	protected void registerConfigChangeLister()
	{
		...
		cfgChangeListener = new ConfigChangeListenerImpl();
