...
public class GoogleMapsBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
			throws Exception
	{
		modelAndView.addObject(GOOGLE_API_VERSION, configurationService.getConfiguration().getString(GOOGLE_API_VERSION));
		...
		{
			modelAndView.addObject(GOOGLE_API_KEY_ID, googleApiKey);
		}
	}
