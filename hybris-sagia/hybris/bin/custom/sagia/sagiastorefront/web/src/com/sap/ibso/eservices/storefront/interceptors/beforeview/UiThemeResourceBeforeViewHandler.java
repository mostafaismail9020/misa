...
import com.sap.ibso.eservices.storefront.web.view.UiExperienceViewResolver;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler {
    ...
    public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView) {
        ...
        request.setAttribute("themeResourcePath", themeResourcePath);
        ...
        modelAndView.addObject("gtmContainerId", Config.getParameter("gtm.container.id." + siteName));
