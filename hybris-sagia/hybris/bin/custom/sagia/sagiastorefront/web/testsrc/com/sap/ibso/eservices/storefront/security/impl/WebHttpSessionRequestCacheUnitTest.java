...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sagiastorefront/electronics/en",
						"https://electronics.local:9002/sagiastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sagiastorefront/electronics/en",
						"https://electronics.local:9002/sagiastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sagiastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sagiastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sagiastorefront/electronics/en",
						"https://electronics.local:9002/sagiastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sagiastorefront",
						"https://electronics.local:9002/sagiastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sagiastorefront",
						"https://electronics.local:9002/sagiastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sagiastorefront/electronics/en",
						"https://electronics.local:9002/sagiastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
