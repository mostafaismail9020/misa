    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer tc-footer">
                <a href = "/en/licenseTermsAndConditions/download/sagiaCMSParagraphMediaComponent" target="_blank" download class="btn btn-ctrl btn_slim text-uppercase font-weight-bold download">
