            ...
            <div class="col-md-6">
                <div class="formRadioBox">
                    <div class="form-group">
                        ...
                        <div class="form-item">
                            <input type="radio" name="hasGCCNationality" id="hasGCCNationalityNO" value="no" class="form-control"/>
                            <label for="hasGCCNationalityNO" id="hasGCCNationalityNOLabel" class="btn btn-ctrl btn-bg btn_bold control-label"><spring:theme code="licenseApplyEntityInformation.hasLicenseSection.no"/></label>
                        </div>
                    </div>
                </div>
            </div>
