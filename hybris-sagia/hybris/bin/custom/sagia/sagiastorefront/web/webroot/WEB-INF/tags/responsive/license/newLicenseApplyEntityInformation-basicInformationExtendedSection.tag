	...
	<div class="formSelectBox">
			<div class="form-group">
				<select id="rhqCenterAdmin" name="rhqCenterAdmin" class="form-control" multiple data-value="">
					 <!--<option value="GCC"><spring:theme code="rhq.investor.activities.center.of.administrative.gcc.value"/></option>-->
                     <option value="MENA"><spring:theme code="rhq.investor.activities.center.of.administrative.mena.value"/></option>
                     <!--<option value="Middle_East_ME"><spring:theme code="rhq.investor.activities.center.of.administrative.middleeast.value"/></option>-->
				</select>
...
<script>
   ...
   function showRhqAttachmentSection() {
                      ...
                      var companyRankedInFortuneAttachmentId = document.getElementById("companyRankedInFortuneAttachment");
                       var  rhqCurrentMarketValueName = document.querySelector('input[name="rhqCurrentMarketValue"]:checked');
                       var  rhqAverage3YearRevenueName = document.querySelector('input[name="rhqAverage3YearRevenue"]:checked');
