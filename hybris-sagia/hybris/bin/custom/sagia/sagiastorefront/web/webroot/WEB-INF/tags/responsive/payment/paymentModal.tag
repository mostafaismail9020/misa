                ...
                <div class="modal-footer modal-footer_centered modal-footer_iconButton mb-5 mt-3">
                    <div class="d-flex justify-center">
                        <!-- <div class="text-center p-0 d-flex"> -->
                           <div class="mr-3"> <button type="button" class="btn-outline payment-btn" data-dismiss="modal" onclick="SAGIA.payment.displayPaymentModel()"><span class="pr-3"><icon:creditCard/></span><spring:theme code="license.apply.paywithcc"/></button></div>
                           <div> <button type="button" class="btn-outline payment-btn" data-dismiss="modal" onclick="SAGIA.payment.displayPayWithSadadMessage()"><span class="pay-with-salad"><icon:sadad/></span><spring:theme code="license.apply.paywithsadad"/></button></div>
                        <!-- </div> -->
