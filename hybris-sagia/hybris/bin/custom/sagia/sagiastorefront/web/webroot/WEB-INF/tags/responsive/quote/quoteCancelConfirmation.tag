...
<div style="display:none">
	<spring:theme code="text.quote.cancel.confirmation.modal.title" arguments="${quoteData.code}" var="cancelConfirmationModalTitle"/>
        ...
        <div class="modal__bottom">
            <c:if test="${(not empty quoteData.expirationTime) && allowedActions['CHECKOUT']}">
                <p class="modal__bottom--text">
                    <fmt:formatDate value="${quoteData.expirationTime}" dateStyle="medium" timeStyle="short" type="both" var="formattedExpirationTime"/>
