...
<div id="accordionTransaction2" class="services-container-tabcontent">
    <div class="accordion-item" style="width: 100%">
        <h5 class="mb-0">
            <button class="accordion-button collapsed" data-toggle="collapse" data-target="#collapseTransaction1"
    ...
    <div class="accordion-item" style="width: 100%">
        <h5 class="mb-0">
            <button class="accordion-button collapsed" data-toggle="collapse" data-target="#collapseTransaction2"
                    aria-expanded="false" aria-controls="collapseThree">
