...
<form id="changeUsername">
    ...
    <div class="contentModule-actions contentModule-actions_centered contentModule-actions_insideSection">
        <button id="cancelUpdateUsernameButton" type="button" class="btn btn-secondary"><spring:theme code="text.account.profile.cancel" text="Cancel"/></button>
        <button type="button" id="updateUsername" class="btn"><spring:theme code="text.account.profile.saveUpdates" text="Save Updates"/></button>
    </div>
</form>
