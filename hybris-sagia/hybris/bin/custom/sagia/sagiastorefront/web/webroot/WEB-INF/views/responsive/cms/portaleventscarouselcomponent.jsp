                                	...
                                	<div class="row  align-items-center  ">
                                    	<div class="container">
                                        	<div class="col-md-6 col-sm-12">
                                               <h2 class="News_Press_Releases"><spring:theme code="portal.media.event" text = "Events"/></h2>
                                            </div> 
                                      	</div>
                                      	<div class="col-md-5 col-sm-12 content-slider-part">
                                        	<div class="News_press_bgwhite">
                                            	<div class="top_date position-absolute">
                                               		<h4 class="date"><fmt:formatDate value="${event.eventStartDate}" pattern="d" /></h4>
                                               		<h6 class="date_name"><fmt:formatDate value="${event.eventEndDate}" pattern="MMMM" /></h6>
                                            	</div>
                                            	<div class="p-5 paddding_align">
                                                	<div>
                                                    	<h3 class="highlight_title">${event.eventName}</h3>
                                                    	<p class="para_title">${event.eventShortInformation} </p>
                                                    	<div class="container p-0 ">
                                                       		<div class="row ">
                                                          		<div class="col pull-left p-0">
	                                                             	<a href="${eventUrl}/${event.uid}">
