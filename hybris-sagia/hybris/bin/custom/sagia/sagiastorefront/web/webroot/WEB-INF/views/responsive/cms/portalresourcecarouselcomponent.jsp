	...
	<div class="rect">
   		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" id="carousel" data-interval="false">
        	<div class="carousel-inner">
      			...
      			<c:url value="/mediaCenter/resources" var="resourceUrl"/>      
          		<c:forEach items="${resources}" var="resource">
	           	<div class="carousel-item">
	               	<img class="d-block w-100" src="${fn:escapeXml(resource.resourceThumbnailImage .url)}" alt="${resource.resourceTitle}">
	              	<div class="toplist">
	                        	...
	                        	<div class="row  align-items-center  ">
	                          		<div class="container">
	                             		<div class="col-md-6 col-sm-12">
	                                		<h2 class="News_Press_Releases"><spring:theme code="portal.media.resources" text="RESOURCES"/></h2>
	                             		</div>
	                          		</div>
	                            	<div class="col-md-5 col-sm-12 content-slider-part">
	                               		<div class="News_press_bgwhite">
	                                  		<div class="top_date position-absolute">
	                                     		<h4 class="date"><fmt:formatDate value="${resource.resourceDate}" pattern="d" /></h4>
	                                     		<h6 class="date_name"><fmt:formatDate value="${resource.resourceDate}" pattern="MMMM" /></h6>
	                                  		</div>
	                                  		<div class="p-5 paddding_align">
		                                     	<div class="">
		                                        	<h3 class="highlight_title">${resource.resourceTitle}</h3>
		                                        	<p class="para_title">${resource.resourceShortInformation} </p>
		                                        	<div class="container p-0 ">
		                                           		<div class="row ">
		                                              		<div class="col pull-left p-0">
		                                               			<a href="${resourceUrl}/${resource.uid}">
