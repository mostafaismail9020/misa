                ...
                <%@ taglib prefix="pagination" tagdir="/WEB-INF/tags/responsive/nav/pagination" %>
                    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                        <%@ taglib prefix="nav" tagdir="/WEB-INF/tags/responsive/nav" %>
                            ...
                            <spring:url value="/search/autocomplete/sagia-search-box-component" var="autocompleteUrl"
                                htmlEscape="false">
                            ...
                            <div class="container">
                                <div class="row p-2">
                                    <c:if test="${not empty searchPageData.results}">
                                        <div class="col-md-5 col-xl-3 col-sm-12 my-4 d-none d-md-block opp-filter-container opportunity-card <c:if test="
                                            ${language eq 'ar' }"> text-right
                                    </c:if>
                                    <c:if test="${language eq 'en' }"> text-left</c:if>">
                                    <form name="search_form_${fn:escapeXml(component.uid)}" method="get"
                                        action="${searchUrl}">
                                        <spring:theme code="portal.opportunity.searchby.placeholder"
                                            var="searchPlaceholder" />
                                        <ycommerce:testId code="header_search_input">
                                            <input type="text" id="js-site-search-input" data-test="asdfg"
                                                class="js-site-search-input" name="q"
                                                value="${fn:containsIgnoreCase(request.getParameter(" q"), ':' ) ? '' :
                                                request.getParameter("q")}" maxlength="100"
                                            ...
                                            <a class="a-search">
                                                <img class="img-fluid search-icon" width="20"
                                                    src="${commonResourcePath}/images/Icon-awesome-search.png" alt="" />
                                            </a>
                                        </ycommerce:testId>
						...
						<spring:message code="portal.opportunity.search.opportunities.totalResults" arguments="${searchPageData.pagination.totalNumberOfResults}"/>
                                    ...
                                    <div id="product-facet" style="height: inherit"
                                ...
                                <div class="col-md-7 col-xl-9 col-sm-12 page-main-content">
                                    <c:if test="${not empty searchPageData.results}">
                                        <div class="opp-mobile-show text-center">
                                            <spring:theme code="portal.opportunity.search.modal.btn"
                                                var="btnModalTxt" />
                                            <button id="opp-open-modal-filter"
                                                class="btn btn-secondary-fill">${btnModalTxt}</button>
                                            <div class="opportunity-card total-results mt-2 mb-3">
                                                <spring:message
                                                    code="portal.opportunity.search.opportunities.totalResults"
                                                    arguments="${searchPageData.pagination.totalNumberOfResults}" />
                                            </div>
                                        </div>
                                        <div
                                            class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 opportunity-card opp-filter opp-mobile-show">
                                            <!-- Modal -->
                                            <div class="modal fade" id="facetFilterModal" tabindex="-1" role="dialog"
                                                aria-hidden="true">
                                        ...
                                        <div class="opportunity-card opp-sort">
                                            <div class="dashboardWidget-headline js-dashboardWidget-headline">
                                                <form id="sortForm1" name="sortForm1" method="get" action="#">
                                                    <div class="sorting">
                                                        <div class="sortby">
                                                            <label for="opportunity-search" class="full">
                                                                <spring:theme code="sagia.sort.sort.by" />
                                                            </label>
                                                            <select id="sortOptions1" name="sort"
                                                                class="form-control--plp-sorting browser-default custom-select form-control">
                                                                <c:forEach items="${solrSearchPageData.sorts}"
                                                                    var="sort">
                                                                    <option value="${fn:escapeXml(sort.code)}"
                                                                        ...
                                                                        <c:choose>
                                                                            ...
                                                                            <c:otherwise>
                                                                                <spring:theme
                                                                                    code="${themeMsgKey}.sort.${sort.code}" />
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </option>
                                                                </c:forEach>
                                                    ...
                                                    <c:catch var="errorException">
                                                        <spring:eval expression="solrSearchPageData.currentQuery.query"
                                                            var="dummyVar" /><%-- This will throw an exception is it is
                                                            not supported --%>
                                                            <input type="hidden" name="q"
                                                                value="${solrSearchPageData.currentQuery.query.value}" />
                                                    </c:catch>
                                    ...
                                    <c:choose>
                                        <c:when test="${ not empty searchPageData.results}">
                                            <div class="row">
                                                <c:forEach var="result" items="${searchPageData.results}"
                                                    varStatus="status">
                                                    <tags:opportunity-card result="${result}"
                                                        loopCount="${status.index}" />
                                                </c:forEach>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <ul class="pagination pg-darkgrey justify-content-center mt-4">
                                            ...
                                            <c:if test="${hasPreviousPage}">
                                                <spring:url
                                                    value="${fn:replace(solrSearchPageData.currentQuery.url,'search','sectors-opportunities/opportunities')}"
                                                    var="previousPageUrl" htmlEscape="true">
                                                    <spring:param name="page"
                                                        value="${solrSearchPageData.pagination.currentPage - 1}" />
                                                </spring:url>
                                                <li class="page-item previous-page">
                                                    <a class="page-link waves-effect waves-light"
                                                        href="${previousPageUrl}">
                                                        <img class="img-fluid previous-left-blue-icon" width="20"
                                                            src="${commonResourcePath}/images/previous-arrow-left.png"
                                                            alt="" />
                                                        <img class="img-fluid previous-left-white-icon"
                                                            style="display: none;" width="20"
                                                            src="${commonResourcePath}/images/previous-white-arrow-left.png"
                                                            alt="" />
                                                    </a>
                                                </li>
                                            </c:if>
                                            ...
                                            <c:set var="beginPage">
                                                <c:choose>
                                                    <%-- Limit is higher than number of pages --%>
                                                        <c:when
                                                            test="${limit gt searchPageData.pagination.numberOfPages}">1
                                                        </c:when>
                                                        <%-- Start shifting page numbers once currentPage reaches
                                                            halfway point--%>
                                                            <c:when
                                                                ...
                                                                <c:choose>
                                                                    <c:when
                                                                        ...
                                                                        <%-- Avoid rounding issue--%>
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${searchPageData.pagination.currentPage + 1 - halfLimit gt 0}">
                                                                                    ${searchPageData.pagination.currentPage
                                                                                    + 1 - halfLimit}
                                                                                </c:when>
                                                                    ...
                                                                    <c:otherwise>
                                                                        ${searchPageData.pagination.numberOfPages + 1 -
                                                                        limit}</c:otherwise>
                                                                </c:choose>
                                                            </c:when>
                                                            <c:otherwise>1</c:otherwise>
                                            ...
                                            <c:forEach begin="${startPagination}" end="${endPagination}"
                                                var="currentPage">
                                                <spring:url
                                                    value="${fn:replace(solrSearchPageData.currentQuery.url,'search','sectors-opportunities/opportunities')}"
                                                    var="pageNumberUrl" htmlEscape="true">
                                                ...
                                                <c:choose>
                                                    <c:when test="${currentPage eq param.page + 1}">
                                                        <li class="page-item active"><a
                                                                class="page-link waves-effect waves-light"
                                            ...
                                            <c:if test="${hasNextPage}">
                                                ...
                                                <li class="page-item next-page">
                                                    <a class="page-link waves-effect waves-light" href="${nextPageUrl}"
                                                        style="padding-top: 10px;">
                                                        <img class="img-fluid arrow-left-blue-icon" width="20"
                                                            src="${commonResourcePath}/images/Icon-feather-arrow-left.png"
                                                            alt="" />
                                                        <img class="img-fluid arrow-left-white-icon"
                                                            style="display: none;" width="20"
                                                            src="${commonResourcePath}/images/Icon-white-arrow-left.png"
                                                            alt="" />
                                                    </a>
                                                </li>
                                            </c:if>
