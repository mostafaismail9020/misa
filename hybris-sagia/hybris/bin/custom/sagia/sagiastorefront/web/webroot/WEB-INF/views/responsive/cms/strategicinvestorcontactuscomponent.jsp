...
<c:if test="${component.visible}">
    <section class="mizaSection mizaEnquiry p100 company-mgr-quote" id="strategic-contact-form">
    
            <div class="container-fluid">
               <h2 class="mizaTitle  wow fadeInUp    animated" data-wow-delay="300ms" data-wow-duration="1s"><span class="clr_gld"><spring:theme code="portal.strategic.contact.expert.name.label"/></span></h2>
            ...
            <div class="contactSuccess d-none">
                ...
                <p class="contact-sucess-ticket"></p>
                    ...
                    <div class=" wow fadeIn mizaEnquiryFromWrap " data-wow-delay="0.2s" id="strategicContactForm">
                        <div class="row">
                               <div class=" col-md-6 ">
