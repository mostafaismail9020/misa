...
<div class="modal-content">
    <div class="modal-header">
        <div class="modal-title" id="exampleModalLabel"><spring:theme code="general.ticketNumber"/> ${expandedComplaintFormData.srID}</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="ticketModule-actions">
                            <button class="btn" id="newMessageBtn" data-current-srid="${expandedComplaintFormData.srID}" <c:if test="${expandedComplaintFormData.srStCode == 'E0010'}"> disabled </c:if>><spring:theme code="general.send.message"/>
                            </button>
                        </div>
                    </div>
