...
<div class="modal-content">
    <div class="modal-header">
        <div class="modal-title" id="exampleModalLabel"><spring:theme code="general.ticketNumber"/>: ${financialStatement_detail.srId}</div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="ticketModule-details">
                            <%-- <p><span
                                    class="ticketModule-label"><spring:theme code="general.type"/></span> ${financialStatement_detail.legalInquiry.legEnqDesc}
                            </p> --%>
                            <p><span
                                    class="ticketModule-label"><spring:theme code="general.status"/></span> ${financialStatement_detail.srStDesc}
                            </p>
                            ...
                            <ul class="downloadList downloadList_secondary">
                                <c:forEach items="${financialStatement_detail.contentHDRSet}" var="attachment">
                    ...
                    <%-- <div class="col-md-8">
                        <ul id="messagesList" class="messageList">
                            <c:forEach items="${financialStatement_detail.getTextSet}" var="message">
