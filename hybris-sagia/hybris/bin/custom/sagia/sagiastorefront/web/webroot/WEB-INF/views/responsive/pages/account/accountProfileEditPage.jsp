...
<%--@elvariable id="updateProfileForm" type="de.hybris.platform.acceleratorstorefrontcommons.forms.UpdateProfileForm"--%>
<%--@elvariable id="titleData" type="java.util.List<de.hybris.platform.commercefacades.user.data.TitleData>"--%>
