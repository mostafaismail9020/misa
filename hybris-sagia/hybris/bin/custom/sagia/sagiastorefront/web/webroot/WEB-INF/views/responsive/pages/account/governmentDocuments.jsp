           ...
           <c:if test="${branchData.statusCode == 'V' || branchData.statusCode == 'I' }">
            ...
            <div class="contentModule">
              ...
              <div class="contentModule-section">
                ...
                <spring:theme code="general.governmentdocuments.commercialregister" /></div>
                <div class="row">
                  <div class="col-md-6">
                    <formElement:formInputBox idKey="govDocs.CRN"
                                              labelKey="govDocs.CRN" path="commercialRegisterNumber" inputCSS="form-control"
                                              mandatory="true" labelCSS="control-label_mandatory" disabled="${disabledFields}"/>
                  </div>
                  <div class="col-md-6">
                    <formElement:formInputBox idKey="govDocs.gosiNo"
                                              labelKey="govDocs.gosiNo" path="gosiNumber" inputCSS="form-control"
                                              mandatory="true" labelCSS="control-label_mandatory" disabled="${disabledFields}" />
                  </div>
                  <div class="col-md-6">
                    <formElement:formInputBox idKey="govDocs.zakatNo"
                                              labelKey="govDocs.zakatNo" path="zakatNumber" inputCSS="form-control"
                                              mandatory="true" labelCSS="control-label_mandatory" disabled="${disabledFields}"/>
                  </div>
                  <div class="col-md-6">
                    <formElement:formInputBox idKey="govDocs.molNo"
                                              labelKey="govDocs.molNo" path="molNumber" inputCSS="form-control"
                                              mandatory="true" labelCSS="control-label_mandatory" disabled="${disabledFields}"/>
                  </div>
                </div>
              </div>
              ...
              <div class="contentModule-section">
                ...
                <span class="iconElement iconElement_momra"><icon:momra/></span>
                  <spring:theme code="govDocs.Momra"/></div>
                <div class="row">
                  <div class="col">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <formElement:formInputBox idKey="govDocs.shopLicNo"
                                              labelKey="govDocs.shopLicNo" path="shopLicenseNumber" inputCSS="form-control gov-docs-shopLicNo"
                                              mandatory="true" labelCSS="control-label_mandatory" disabled="${disabledFields}"/>
                  </div>
                  <div class="col-md-6">
                    <formElement:formSelectBox idKey="govDocs.amanah"
                                               labelKey="govDocs.amanah" selectCSSClass="form-control gov-docs-amanah"
                                               path="amanah" mandatory="true" skipBlank="false" itemLabel="name" itemValue="key"
                                               skipBlankMessageKey="form.select.empty" labelCSS="control-label_mandatory" items="${amanahs}" disabled="${disabledFields}"/>
                  </div>
                </div>
              </div>
              ...
              <div class="contentModule-section">
                ...
                <spring:theme code="general.governmentdocuments.comments" /></div>
                <div class="row">
                  <div class="col">
                    <formElement:formTextArea areaCSS="form-control" idKey="govDocs.comments"
                                              labelKey="govDocs.comments"
                                              path="comments" mandatory="false" disabled="${disabledFields}"/>
                  </div>
                </div>
              </div>
            </div>
