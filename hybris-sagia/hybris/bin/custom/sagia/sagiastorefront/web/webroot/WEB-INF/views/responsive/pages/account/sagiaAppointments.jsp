                        ...
                        <c:forEach items="${appointments}" var="item" varStatus="countme">
                            ...
                            <c:if test="${not empty item.statusDescription}">
                                ...
                                <c:set var="statusClass"
                                       value="appointmentList-icon_status appointmentList-icon_status_${fn:toLowerCase(stringSplit[0])}"/>
                            </c:if>
                            ...
                            <tr class="appointmentList-entry">
                                ...
                                <td class="appointmentList-status" data-type="${item.serviceType1Description}"
                                    data-state="${item.statusDescription}"><span class="appointmentList-label"><spring:theme code="appointments.status"/></span>
                        ...
                        <div class="container">
                            ...
                            <form:form method="GET" action="${encodedContextPath}/appointments?site=sagia" modelAttribute="appointmentModel">
                                <div class="appointmentDetails appointmentDetails_forms">
                                    <h2 class="headline headline-icon headline-icon_details"><spring:theme code="appointments.appointmentdetails"/></h2>
                                    <div class="row">
                                        <div class="col-xs-8 col-md-6">
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    <form:select path="department"
                                                                 cssClass="js-select2-oneColumn form-control">
                                                        <option></option>
                                    ...
                                    <div class="row service-selection">
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    <form:select path="servType1"
                                                                 cssClass="js-select2-oneColumn service-type">
                                                        <option></option>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    <form:select path="ministry1"
                                                                 cssClass="js-select2-oneColumn ministry"
                                                                 disabled="true">
                                                        <option></option>
                                                        <form:options items="${ministries}"
                                                                      itemValue="${not empty itemValue ? itemValue :'FieldKey'}"
                                                                      itemLabel="${not empty itemLabel ? itemLabel :'Description'}"
                                                                      htmlEscape="true"/>
                                                    </form:select>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    <form:select path="service1" cssClass="js-select2-oneColumn service"
                                                                 disabled="true">
                                                        <option></option>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    ...
                                                    <form:select path="service2" cssClass="js-select2-oneColumn service"
                                                                 disabled="true">
                                                        <option></option>
                                                        <form:options items="${services}"
                                                                      itemValue="${not empty itemValue ? itemValue :'FieldKey'}"
                                    ...
                                    <div class="row service-selection">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    <form:select path="service3" cssClass="js-select2-oneColumn service"
                                                                 disabled="true">
                                                        <option></option>
                                                        <form:options items="${services}"
                                                                      itemValue="${not empty itemValue ? itemValue :'FieldKey'}"
                                    ...
                                    <hr class="contentModule-section-delimiter"/>
                                    <h2 class="headline"><spring:theme code="register.national.investor.availableslots"/></h2>
                                    <div class="row">
                                        <div class="col-xs-8 col-md-6">
...
<table class="appointmentTemplateWrapper" style="display: none">
    <tr class="appointmentList-entry">
        ...
        <td class="appointmentList-status" data-type=""
            data-state=""><span class="appointmentList-label"><spring:theme code="appointments.status"/></span>
            <button class="appointmentList-status-value appointmentList-icon_after ">
                <span></span></button>
        </td>
        <td class="appointmentList-view">
            <a href="${encodedContextPath}/appointments/details/"
               class="btn btn_link appointmentList-viewBtn appointmentList-icon_view">
