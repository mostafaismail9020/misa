                                                            ...
                                                            <div class="container">
                                                                <div class="mainSection-linkActions mainSection-linkActions_spaceBetween">
                                                                    <div class="w-25 appointments_create">
                                                                        <a href="${encodedContextPath}/appointments" class="btn btn_leftIconLink btn_darkLink back_to_service  appointmentControl-backBtn appoint-btn">
                                                                            ...
                                                                            <spring:theme code="appointments.backToOverview"/>
                                                                        </a>
                                                                    </div>
                                                                    <%--<div>
