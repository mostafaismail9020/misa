...
<div class="mainSection mainSection mainSection_dark mainSection_noPadding">
    <div class="container">
        <div class="mainSection-linkActions mainSection-linkActions_spaceBetween">
            <div>
                <a href="${encodedContextPath}/appointments" class="btn btn_leftIconLink btn_darkLink appointmentControl-backBtn"><span class="iconElement iconElement_closeBack"><icon:close/></span><span
    ...
    <div class="container">
        <div class="panelModule panelModule_halfRadius appointmentDetails">
            ...
            <div class="appointmentDetails appointmentDetails_forms">
                <div class="contentModule-headline"><icon:calendarText/><spring:theme code="appointments.appointmentdetails"/></div>
                <div class="row">
                ...
                <div class="contentModule-headline"><spring:theme code="appointments.services"/></div>
                ...
                <hr class="contentModule-section-delimiter"/>
                <div class="contentModule-headline"><spring:theme code="appointments.availableslots"/></div>
                <div class="row">
                    <div class="col-xs-8 col-md-6">
                        <div class="formInputBox formInputBox_group ">
                            <div class="form-group">
                                <form:input path="dateString"
                                            cssClass="form-control js-form-control_date flatpickr-input"
                                            placeholder="."/>
                    ...
                    <div class="col-xs-8 col-md-6">
                        <div class="formInputBox formInputBox_group ">
                            <div class="form-group">
                                <form:input path="timeStartString" cssClass="form-control js-form-control_timeslot"
                                            placeholder="." data-dates-enabled="10:00#17:30"/>
                        ...
                        <div class="formSelectBox">
                            <div class="form-group">
                                <form:select path="contactPerson" cssClass="js-select2-oneColumn contact-person">
                                    <option></option>
                                    <form:options items="${contactPersons}"
                                                  itemValue="${not empty itemValue ? itemValue :'dockeyID'}"
                                                  itemLabel="${not empty itemLabel ? itemLabel :'longDescription'}"
                                                  htmlEscape="true"/>
                                </form:select>
		            ...
		            <div class="col">
		                <div class="formTextArea">
		                    <div class="form-group">
		                        ...
		                        <textarea id="notes" class="form-control" placeholder="." name="notes"></textarea>
