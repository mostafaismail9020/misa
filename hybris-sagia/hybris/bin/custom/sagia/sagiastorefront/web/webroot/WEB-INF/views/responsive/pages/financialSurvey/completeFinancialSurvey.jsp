                                    ...
                                    <table>
                                        <tr class="subsidiaryTemplate">
                                            ...
                                            <td class="tableModule-bodyItem-action">
                                                ...
                                                <button type="button" class="btn btn_link viewSubsidiaryBtn"
                                                        data-toggle="modal" data-target="#subsidiaryModalId"
                                                        data-backdrop="static" data-keyboard="false">
                                                    <icon:view/>
                                                </button>
                                    ...
                                    <table id="subsidiariesTableId" class="tableModule-table">
                                        ...
                                        <tr>
                                            ...
                                            <th><spring:theme
                                                    ...
                                                    class="sort-icon"></span></th>
                                            <th><spring:theme
                                                    code="financial.survey.subsidiaries.unifiedNo"/> <span
                                                    class="sort-icon"></span></th>
                    ...
                    <div class="panelTabs-body">
                        <div class="contentModule">
                                    ...
                                    <div class="row">
                                       ...
                                       <%-- <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="formInputBox">
                                                <div class="form-group">
                                                    <input id="totalAffiliateEquityCurrentQuarterId"
                                                           name="totalAffiliateEquityCurrentQuarter"
                                                           class="form-control" placeholder="." value="" type="text"
                                                           dir="ltr" disabled="true"
                                                           maxlength="80"> <label class="control-label"
                                                                                  for="totalAffiliateEquityCurrentQuarterId">
                                                    <spring:theme
                                                            code="financial.survey.totalAffiliateEquity.currentQuarter"/>
                                                </label>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                            ...
                            <div
                                ...
                                <button id="nextTabAffiliatesEquityBtnId" type="button"
                                        class="btn newAmendmentBtn">
                                    <spring:theme code="general.proceed"/>
                                </button>
                            </div>
                    ...
                    <div class="panelTabs-body">
                        ...
                        <div id="attachmentSection" class="contentModule-section">
                            ...
                            <div class="col-12">
                                <div class="formInputFile">
                                    <div class="form-group">
                                        ...
                                        <input id="testId" name="test" class="form-control js-inputFile" type="file"
                                               accept="application/pdf">
                                        <input class="form-control" type="text" value="" placeholder=""
                                               readonly="readonly"
                                               tabindex="-1">
                                        <label class="control-label "><spring:theme
                                                code="financial.survey.attachment.interimFinancialStatements"/></label>
                            ...
                            <div class="col-12">
                                <div class="formInputFile">
                                    <div class="form-group">
                                        <input name="annualFinancialStatement" class="form-control js-inputFile" type="file"
                                               accept="application/pdf">
                                        <input class="form-control" type="text" value="" placeholder=""
                                               readonly="readonly"
                                               tabindex="-1">
                                        <label class="control-label "><spring:theme
                                                code="financial.survey.attachment.annualFinancialStatements"/></label>
                                        <div class="form-icon form-icon_browse"><icon:upload/></div>
                                        <div class="form-icon form-icon_reset js-inputFile-reset"><icon:cross/></div>
                                        <div class="help-block"></div>
                                    </div>
        ...
        <div class="modal-content panelModule panelModule_halfRadius">
            ...
            <form class="editAffiliate">
                ...
                <div
                    ...
                    <button type="button" class="btn btn-slim saveEditAffiliateBtn">
