                                            ...
                                            <div class="formSelectBox">
                                                <div class="form-group">
                                                    <select id="divisionId" name="division"
                                                            class="js-select2-search form-control"></select> <label
                                                        class="control-label control-label_mandatory"
                                                        for="divisionId"><spring:theme code="survey.division"/></label>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="paidUpCapitalPreviousQuarterId"
                                                               name="paidUpCapitalPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="additionalPaidUpCapitalPreviousQuarterId"
                                                               name="additionalPaidUpCapitalPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="retainedEarningsIncludePreviousQuarterId"
                                                               name="retainedEarningsIncludePreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="totalReservesPreviousQuarterId"
                                                               name="totalReservesPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="treasurySharesPreviousQuarterId"
                                                               name="treasurySharesPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="headOfficeAccountInBranchPreviousQuarterId"
                                                               name="headOfficeAccountInBranchPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                 ...
                                                 <div class="formInputBox">
                                                     <div class="form-group">
                                                         <input id="shareholderEquityOthersPreviousQuarterId"
                                                                name="shareholderEquityOthersPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                                class="form-control" placeholder="." value="" type="text"
                                                                dir="ltr"
                                                                maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="minorityRightsPreviousQuarterId"
                                                               name="minorityRightsPreviousQuarter" onchange="caluculateTotalCapitalPreviousQuarter()"
                                                               class="form-control" placeholder="." value="" type="text"
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="totalShareholderEquityPreviousQuarterId"
                                                               ...
                                                               dir="ltr" disabled="true"
                                                               maxlength="80"> <label class="control-label"
                                                                                      for="totalShareholderEquityPreviousQuarterID">
                                                        <spring:theme
                                                                code="financial.survey.totalShareholderEquity.previousQuarter"/>
                                                    </label>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
...
<%--                        TEST END--%>
                        ...
                        <div id="accordionTransaction">
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h5 class="mb-0">
                                       <button class="btn btn-link" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            <spring:theme code="general.edit.button.shareholderequity"/>
                                        </button>
                                    </h5>
                                </div>

                                <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionTransaction">
                                    <div class="card-body">
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="shareholderRetainedEarningsIncludePreviousQuarterId"
                                                               ...
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                                                      for="shareholderRetainedEarningsIncludePreviousQuarterId">
                                                        <spring:theme
                                                                code="financial.survey.shareholderEquity.retainedEarningsInclude.previousQuarter"/>
                                                    </label>
                                                        <div class="help-block"></div>
                                                ...
                                                <div class="formInputBox">
                                                    <div class="form-group">
                                                        <input id="shareholderProfitLossQuarterPreviousQuarterId"
                                                               ...
                                                               dir="ltr"
                                                               maxlength="80"> <label class="control-label"
                                                                                      for="shareholderProfitLossQuarterPreviousQuarterId">
                                                        <spring:theme
                                                                code="financial.survey.shareholderEquity.profitLossQuarter.previousQuarter"/>
                                                    </label>
                                                        <div class="help-block"></div>
