    ...
    <form:form id="temporaryBiddingLicenseFormId" action="${encodedContextPath}/my-sagia/license/bidding-create" method="post" modelAttribute="sagiaTemporaryBiddingLicenseForm" enctype="multipart/form-data">
        ...
        <div class="panelTabs-body">
            <div class="contentModule">
                <div class="contentModule-section">
                    <div class="row">
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="companyNameInArabicId"
                                                      labelKey="temporaryBiddingLicense.companyNameInArabic"
                                                      path="companyNameInArabic"
                                                      inputCSS="form-control" maxlength="60"/>
                        </div>
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="companyNameInEnglishId"
                                                      labelKey="temporaryBiddingLicense.companyNameInEnglish"
                                                      path="companyNameInEnglish"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                                                      mandatory="true" maxlength="60"/>
                        </div>
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="projectNameInArabicId"
                                                      labelKey="temporaryBiddingLicense.projectNameInArabic"
                                                      path="projectNameInArabic"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                                                      mandatory="true" maxlength="60"/>
                        </div>
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="projectNameInEnglishId"
                                                      labelKey="temporaryBiddingLicense.projectNameInEnglish"
                                                      path="projectNameInEnglish"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                                                      mandatory="true" maxlength="60"/>
                        </div>
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="capitalId"
                                                      labelKey="temporaryBiddingLicense.capital"
                                                      path="capital"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                        ...
                        <div class="col-md-6">
                            <formElement:formSelectBox idKey="governmentEntityId"
                                                       labelKey="temporaryBiddingLicense.governmentEntity"
                        ...
                        <div class="col-md-6">
                            <formElement:formSelectBox idKey="countryId"
                                                       labelKey="temporaryBiddingLicense.country"
                                                       path="country"
                                                       items="${countries}"
                                                       itemLabel="name"
                                                       itemValue="code"
                        ...
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="cityId"
                                                      labelKey="temporaryBiddingLicense.city"
                                                      path="city"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                                                      mandatory="true" maxlength="60"/>
                        ...
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="postalCodeId"
                                                      labelKey="temporaryBiddingLicense.postalCode"
                                                      path="postalCode"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                        ...
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="poBoxId"
                                                      labelKey="temporaryBiddingLicense.poBox"
                                                      path="poBox"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                                                      mandatory="true" maxlength="10"/>
                        ...
                        <div class="col-md-6">
                            <div class="formInputBox-split">
                                ...
                                <div class="formInputBox formInputBox_big">
                                    <formElement:formInputBox idKey="mobileId"
                                                              labelKey="temporaryBiddingLicense.mobile"
                                                              path="mobile"
                                                              inputCSS="form-control form-control_labeled"
                                                              labelCSS="control-label_mandatory"
                                                              mandatory="true" maxlength="32"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="formInputBox-split">
                                ...
                                <div class="formInputBox formInputBox_big">
                                        <formElement:formInputBox idKey="telephoneId"
                                                                  labelKey="temporaryBiddingLicense.telephone"
                                                                  path="telephone"
                                                                  inputCSS="form-control form-control_labeled"
                                                                  labelCSS="control-label_mandatory"
                                                                  mandatory="true" maxlength="32"/>
                        ...
                        <div class="col-md-6">
                            <formElement:formInputBox idKey="emailId"
                                                      labelKey="temporaryBiddingLicense.email"
                                                      path="email"
                                                      inputCSS="form-control"
                                                      labelCSS="control-label_mandatory"
                                                      mandatory="true" maxlength="60"/>
                ...
                <div class="contentModule-actions contentModule-actions_spaceBetween">
                    <button id="nextFirstTabButtonId" type="button" class="btn">Next</button>
                </div>
            </div>
        </div>
        ...
        <div class="panelTabs-body">
            <div class="contentModule">
                            ...
                            <div class="formInputFile formInputFile_group">
                                <div class="form-group">
                                    ...
                                    <div class="formInputFile-append">
                                        <span class="formInputFile-text formInputFile-text_tip js-tip" style="position: relative;z-index: 1000;" data-tip-trigger="click click-outside" data-tip-title='This is a short explanation text on "Pledge for complete documentation and cr". You can also go to our <a href="#">help center</a>.' data-original-title="" title=""><icon:tipInfo/></span>
                                    </div>
                                </div>
                                <div class="help-block"></div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="formInputFile formInputFile_group">
                                <div class="form-group">
                                    ...
                                    <div class="formInputFile-append">
                                        <span class="formInputFile-text formInputFile-text_tip js-tip" style="position: relative;z-index: 1000;" data-tip-trigger="click click-outside" data-tip-title='This is a short explanation text on "Classification Letter from the ultimatecountry". You can also go to our <a href="#">help center</a>.' data-original-title="" title="">
                                            <icon:tipInfo/>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="formInputFile formInputFile_group">
                                <div class="form-group">
                                    ...
                                    <div class="formInputFile-append">
                                        <span class="formInputFile-text formInputFile-text_tip js-tip" style="position: relative;z-index: 1000;" data-tip-trigger="click click-outside" data-tip-title='This is a short explanation text. You can also go to our <a href="#">help center</a>.' data-original-title="" title=""><icon:tipInfo/></span>
                                    </div>
                                </div>
                                <div class="help-block"></div>
                            </div>
                ...
                <div class="contentModule-actions contentModule-actions_spaceBetween">
                    <button id="nextSecondTabButtonId" type="button" class="btn">
            ...
            <div class="contentModule">
                ...
                <div class="contentModule-section contentModule-section_noDivider">
                    <div class="contentModule-actions contentModule-actions_spaceBetween contentModule-actions_wrap contentModule-actions_bordered_green">
                        <div class="contentModule-headline"><icon:info/><spring:theme code="temporaryBiddingLicense.entityInformation"/></div>
                ...
                <div class="contentModule-section">
                    <div class="contentModule-actions contentModule-actions_spaceBetween contentModule-actions_wrap contentModule-actions_bordered_green">
                        <div class="contentModule-headline"><icon:documents/> <spring:theme code="temporaryBiddingLicense.uploadDocuments"/></div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-xs modal-dialog-centeredContent" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title"><spring:theme code="biddingLicense.error.text"/></div>
