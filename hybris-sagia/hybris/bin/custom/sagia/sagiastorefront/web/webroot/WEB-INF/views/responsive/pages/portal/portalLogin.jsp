...
<template:portalpage pageTitle="${pageTitle}">
	...
	<div class=background>    
		<div class="no-touch_screen">
			<div class="myDiv"></div>
			<div class="misa-white-img wow fadeIn" style="visibility: visible; animation-name: fadeIn;"></div>
			<div class="container-fluid main-container wow fadeIn" style="padding: 0px; visibility: visible; animation-name: fadeIn;">			  
				<div class="main-container-child">
				<!--	<div class="wow fadeIn main-header" data-wow-delay="0.8s">
					<h1>Absher Platform</h1>
				</div> -->            
					<div class="figure-wrapper1" style="visibility: visible; animation-name: fadeInLeft;">
						<a href="https://eservices.sagia.gov.sa/en"> 
							<img src="/investsaudistorefront/_ui/responsive/common/images/logo-en.svg" alt="" width="250" height="250" /></a>  
						</div>          
						<div class="flex-wrapper">
							<div class="flex-parent">
								<div class="wow fadeInRight figure-wrapper figure-wrapper-indi"	
										style="visibility: visible; animation-name: fadeInRight;">
									<a href="/investsaudistorefront/investsaudi/en/login">
										<span>
											<strong>
												<div class="flip-container">
													<div class="flipper">
														<div class="front" >
															<img src="/investsaudistorefront/_ui/responsive/common/images/individual-hover.png"	
																	class="img-hover">            
														</div>
														<div class="back">
															<img src="/investsaudistorefront/_ui/responsive/common/images/IS_White.png"	
																	class="img-normal">            
														</div>
													</div>
												</div>
