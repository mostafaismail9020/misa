                      		...
                      		<li class="nav-item">
                      			...
                      			<c:choose>
		                          	<c:when test="${param.isCurrentYear eq 'false'}">
		                              	<a class="nav-link" id="pills-year-tab" href="${currentYearReportsUrl}" role="tab" 
		                              			aria-controls="pills-year" aria-selected="true"><spring:theme code="portal.media.resources.current.year.reports" text="Current Year Reports"/></a> 
		                          	</c:when>
		                          	<c:otherwise>
		                              	<a class="nav-link active" id="pills-year-tab" href="${currentYearReportsUrl}" role="tab" 
		                              			aria-controls="pills-year" aria-selected="true"><spring:theme code="portal.media.resources.current.year.reports" text="Current Year Reports"/></a> 
		                          	</c:otherwise>
		                      	</c:choose>                      
                      		</li>
                            <li class="nav-item">
                                <c:url value="/mediaCenter/resources?isCurrentYear=${ycommerce:encodeUrl('false')}" var="pastReportsUrl"/>
                                <c:choose>
                                	<c:when test="${param.isCurrentYear eq 'false'}">
                                    	<a class="nav-link active" id="pills-news-tab" href="${pastReportsUrl}" role="tab" 
                                    			aria-controls="pills-news" aria-selected="false"><spring:theme code="portal.media.resources.past.reports" text="Past Reports"/></a>
                                	</c:when>
                                	<c:otherwise>
                                    	<a class="nav-link" id="pills-news-tab" href="${pastReportsUrl}" role="tab" 
                                    			aria-controls="pills-news" aria-selected="false"><spring:theme code="portal.media.resources.past.reports" text="Past Reports"/></a>
                                	</c:otherwise>
                            	</c:choose>                                
                            </li>
                	...
                	<div class="tab-content d-inline" id="pills-tabContent">
                  		<div class="tab-pane fade show active" id="pills-year" role="tabpanel" aria-labelledby="pills-year-tab">
                      		<div class="row">
			                    ...
			                    <c:forEach items="${searchPageData.results}" var="resourceComponent">
		                          	<div class="col-12 col-lg-4 mb-5">
		                              	<div class="news-card">
		                                    ...
		                                    <img class="img-fluid w-100 news-card-img" src="${fn:escapeXml(resourceComponent.resourceThumbnailImage.url)}" 
	                                    ...
	                                    <div class="col-lg-12 col-md-12 col-sm-12">
	                                        <ul class="pagination pg-darkgrey pagination-bottom mt-4">
	                                            ...
	                                            <c:if test="${hasPreviousPage}">
	                                                <li class="page-item">
	                                                	<a class="page-link waves-effect waves-light" href="${pastReportsUrl}${urlWithPage}${searchPageData.pagination.currentPage-1}">
		                                            ...
		                                            <c:choose>
		                                                <c:when test="${currentPage eq param.page + 1}">
		                                                    <li class="page-item active">
		                                                    	<a class="page-link waves-effect waves-light" href=${pastReportsUrl}${urlWithPage}${currentPage-1}>${currentPage}</a>
		                                                    </li>
		                                                </c:when>
		                                                <c:otherwise>
		                                                    <li class="page-item">
		                                        ...
		                                        <c:if test="${hasNextPage}">
		                                            <li class="page-item">
		                                            	<a class="page-link waves-effect waves-light" href="${pastReportsUrl}${urlWithPage}${searchPageData.pagination.numberOfPages-1}">
