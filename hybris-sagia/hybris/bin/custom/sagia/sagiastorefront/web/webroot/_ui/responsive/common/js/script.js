...
$(document).ready(function () {
    ...
    $(".report-facet-form-js").submit( function (e) {
        e.preventDefault()
//        console.log('mount facet url')
        var facets = {}
        $(this).serializeArray().forEach(m => {
...
//        console.log('params', $.param(notEmptyFacet))
	...
	function rendercapitalInformationChart(chartData){
		...
		categoryAxis.title.text = getI18nText("bar.graph.axis.year");
		categoryAxis.renderer.grid.template.strokeWidth = 0;
		categoryAxis.renderer.labels.template.fontSize = $(".capital-formation-period .active").attr("data-id") == 'Annually' ? 16 : 0;
...
if(invVisaPageLang == 'en'){
	...
	$('.countrytypeArabic').css({'display' : 'none'})
        ...
        $(".page-visiting-investor-program #topbar .Header_vs_logo img").attr("src", "/_ui/responsive/common/images/Header_VS_2030-white.svg");
...
const nationalityChange = () => {
	...
	const nationalityChangeAr = () => {
		  ...
		  var instantVisaCountry = ["US", "GB", "CA", "AU", "NZ", "RU", "BN", "JP", "SG", "MY", "KR", "KZ", "MO", "CN", "TW", "HU", "IS", "IT", "LV", "RO", "SK", "HR", "CY", "ES", "SE", "DK", "ET", "FI", "NO", "LU", "FR", "DE", "GR", "SI", "SM", "CH", "IE", "LT", "MC", "MT", "SM", "UA", "PT", "PL", "AT", "BE", "BG", "ME", "AD", "LI", "CZ", "MV", "UZ", "AZ", "KG", "TJ", "AL", "GE", "ZA", "EE", "NL"];
		  var nationalityChangeVal = $('#visaCountryAr').val();
	...
	// Text Animation
$('document').ready(function(){
	const titleSplit = document.querySelectorAll('.page-visiting-investor-program .investorVisaTitle h1, .page-visiting-investor-program .investorVisaTitle h2');
