        ...
        success: function (investmentTerms) {
            ...
            if (investmentTerms && investmentTerms.sgiaIndicatorTerms) {
                investmentTerms.sgiaIndicatorTerms.forEach(function (investmentTerm) {
                    ...
                    $investmentsTermsTable.append('<tr id="'+code+'"><td>'+code+'</td><td>'+investmentTerm.name+'</td><td>'+investmentTerm.description+'</td><td>'+investmentTerm.source+'</td><td><a href="'+investmentTerm.linkLocalizedURL+'"><div class="tableModule-headline">'+investmentTerm.linkText+' </div></a></td></tr>');
                });
            }
            setupTable();
        },
