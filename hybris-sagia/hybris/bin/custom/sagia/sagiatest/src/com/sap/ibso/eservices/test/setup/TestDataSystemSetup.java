 ...
 */
package com.sap.ibso.eservices.test.setup;
...
import com.sap.ibso.eservices.test.constants.SagiaTestConstants;
import com.sap.ibso.eservices.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SagiaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sagiatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sagiatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sagiatest/import/cstickets.impex");
			...
			importImpexFile(context, "/sagiatest/import/csquotes.impex");
		}
	}
}
