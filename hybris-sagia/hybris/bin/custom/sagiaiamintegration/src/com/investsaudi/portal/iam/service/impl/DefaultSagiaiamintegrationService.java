...
public class DefaultSagiaiamintegrationService implements SagiaiamintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSagiaiamintegrationService.class);
	...
	{
		return DefaultSagiaiamintegrationService.class.getResourceAsStream("/sagiaiamintegration/sap-hybris-platform.png");
	}
