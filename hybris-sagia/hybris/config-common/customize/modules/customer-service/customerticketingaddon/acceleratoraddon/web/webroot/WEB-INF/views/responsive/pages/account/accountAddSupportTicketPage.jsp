...
<c:if test="${not empty supportTicketForm}">
    ...
    <div class="back-link border">
        <div class="row">
            <div class="container-rg col-md-6">
                <a href="support-tickets">
                    <span class="glyphicon glyphicon-chevron-left"></span>
                </a>
                <span class="label"><spring:theme code="text.account.${requestType}" /></span>
            </div> 
        </div>
    </div>
                ...
                <div class="account-section-form">
                    ...
                    <form:form method="post" modelAttribute="supportTicketForm" enctype="multipart/form-data">
                        ...
                        <c:when test="${bdUserGroup eq 'BDUserGroup' or nipcUserGroup eq 'NIPCUserGroup'}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                      <label class="control-label control-label_mandatory label-color" for="text.account.supporttickets.bdu.question2"> <spring:theme code="text.account.supporttickets.bdu.question2" text="Sector"/></label>
                                      <form:select path="question20"  id="parentSector" cssClass="form-control"  idKey="createTicket-question2" labelKey="text.account.supporttickets.bdu.question2" labelCSS="label-ticket control-label_mandatory" selectCSSClass="ticket-questions text" mandatory="true" >
                                      ...
                                      <div id="NotEmpty-BDSupportTicketForm-question2" class="help-block" style="display: none;">
                                      <span id="subject-errors"></span>
                                       </div>                                   
                                       <div id="Size-BDSupportTicketForm-question2" class="help-block" style="display: none;"></div>
                                </div>
                            </div>
                            
                            <div class="col-md-6">
                                <div class="form-group">
                                      <label class="control-label control-label_mandatory label-color" for="text.account.supporttickets.bdu.question20"> <spring:theme code="text.account.supporttickets.bdu.question20" text="Subsector"/></label>
                                      <form:select path="question2" id="sector" cssClass="form-control"  idKey="createTicket-question2" labelKey="text.account.supporttickets.bdu.question20" labelCSS="label-ticket control-label_mandatory" selectCSSClass="ticket-questions text" mandatory="true" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <formElement:formInputBox idKey="createTicket-subject" labelKey="text.account.supporttickets.bdu.question1" path="subject" labelCSS="label-ticket-tight control-label_mandatory" inputCSS="text" mandatory="true" />
                                <div id="NotEmpty-BDSupportTicketForm-subject" class="help-block" style="display: none;">
                                    <span id="subject-errors"></span>
                                </div>
                                <div id="Size-BDSupportTicketForm-subject" class="help-block" style="display: none;"></div>
                            </div>
                           
                            <div class="col-md-6">
                                 <div class="form-group">
                                       <formElement:formSelectBox idKey="createTicket-question4" labelKey="text.account.supporttickets.bdu.question4"
                                   path="question4" labelCSS="label-ticket-tight control-label_mandatory"  mandatory="true"
                                   skipBlank="false" skipBlankMessageKey="user.selectUserLocation" items="${regions}"
                                   itemValue="name" selectCSSClass="form-control js-secureportal-userEntity"/>
                                      <div id="NotEmpty-BDSupportTicketForm-question4" class="help-block" style="display: none;">
                                      <span id="subject-errors"></span>
                                       </div>                                   
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <formElement:formInputBox idKey="createTicket-subject" labelKey="text.account.supporttickets.bdu.subject" path="subject" labelCSS="label-ticket control-label_mandatory" inputCSS="text" mandatory="true" />
                                <div id="NotEmpty-BDSupportTicketForm-subject" class="help-block" style="display: none;">
                                    <span id="subject-errors"></span>
                                </div>
                                <div id="Size-BDSupportTicketForm-subject" class="help-block" style="display: none;"></div>
                           ...
                           <div class="col-md-6">
                                <div class="form-group" style="display: none">
                                      <label class="control-label control-label_mandatory label-color" for="text.account.supporttickets.bdu.question2"> <spring:theme code="text.account.supporttickets.bdu.question2" text="Sector"/></label>
                                      <form:select path="question2" id="sector" cssClass="form-control"  idKey="createTicket-question2" labelKey="text.account.supporttickets.bdu.question2" labelCSS="label-ticket control-label_mandatory" selectCSSClass="ticket-questions text" mandatory="true" >
                                           <c:forEach var="sector" items="${sectors}">
								                 <form:option value="${sector.id}">${sector.name}</form:option>
								             </c:forEach>
						               </form:select>
...
<%--                                 </c:if> --%>
                     ...
                     <div> <spring:theme code="text.account.supporttickets.createTicket.note" /></div>              
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-push-6 accountButtons">
                                                <ycommerce:testId code="supportTicket_create_button">
                                                    <button class="btn btn-sagia btn-sagia-green btn-block" type="button" id="addTicket">
                                            ...
                                            <div class="col-sm-6 col-sm-pull-6 accountButtons">
                                                <a href="support-tickets" class="btn btn-sagia btn-block">
